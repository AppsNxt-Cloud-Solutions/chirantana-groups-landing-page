  ...
  return (
    <html lang="en-IN" className={`${fraunces.variable} ${geist.variable}`}>
      ...
      <body className="flex min-h-dvh flex-col bg-surface pb-16 antialiased lg:pb-0">
        ...
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-100 focus:rounded-pill focus:bg-brass-400 focus:px-5 focus:py-2.5 focus:text-sm focus:font-medium focus:text-obsidian-950"
        >
          Skip to content
        </a>
        <Header />
